...
- **showcase**: Optimized `material_gallery` with circular theme toggle, left control sidebar, material-styled tab buttons, 4-up grid symmetry with unified monolithic Mica tile, and dynamic background switcher.
