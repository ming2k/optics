...
//!          resolves `Requires: lens >= 0.0.30` against any stale system
...
fn main() {
    ...
    // (a11y surface matches this header set (0.0.30)); pkg-config fails the build loudly when an older flux/lens/
