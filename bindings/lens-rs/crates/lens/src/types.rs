...
impl Icon {
    pub(crate) fn raw(self) -> sys::lens_icon_id {
        ...
        match self {
            ...
            Icon::MousePointer => LENS_ICON_MOUSE_POINTER,
            ...
            Icon::Sliders => LENS_ICON_SLIDERS,
            ...
            Icon::X => LENS_ICON_X,
            Icon::Square => LENS_ICON_SQUARE,
            Icon::Circle => LENS_ICON_CIRCLE,
            Icon::Slash => LENS_ICON_SLASH,
            Icon::PenTool => LENS_ICON_PEN_TOOL,
            Icon::Type => LENS_ICON_TYPE,
            Icon::RotateCcw => LENS_ICON_ROTATE_CCW,
            Icon::RotateCw => LENS_ICON_ROTATE_CW,
