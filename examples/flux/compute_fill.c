...
/* SPIR-V via C23 #embed; toolchains without it (MSVC cl, Apple Clang)
...
#else
#include "fill_comp_spv.h" /* generated by tools/spv2h.py; same array */
#endif
