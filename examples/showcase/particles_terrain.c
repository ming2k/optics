...
#if __has_embed("particles_terrain.vert.spv") && __has_embed("particles_terrain.frag.spv")
...
#else
#include "particles_terrain_vert_spv.h" /* generated by tools/spv2h.py; same arrays */
#include "particles_terrain_frag_spv.h"
#endif
