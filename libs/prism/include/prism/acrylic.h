...
PRISM_NODISCARD PRISM_API flux_result prism_acrylic_filter_create(flux_device *device,
                                                                  prism_acrylic_filter **out);
...
PRISM_NODISCARD PRISM_API flux_result prism_acrylic_filter_apply(prism_acrylic_filter *filter,
                                                                 flux_frame *frame,
                                                                 const prism_acrylic_desc *desc,
                                                                 flux_image **out);
